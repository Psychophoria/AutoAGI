...
from autoagi import task_finalization_logic_system
...
class AutoAGIApp:
    ...
    def start_ai(self):
        prompt = self.user_request_text.get("1.0", tk.END).strip()
        final_report = task_finalization_logic_system(prompt)
        self.finalized_output_text.insert(tk.END, final_report)
    ...
    def reset_ai(self):
        self.user_request_text.delete("1.0", tk.END)
        self.finalized_output_text.delete("1.0", tk.END)
        self.output_terminal_text.delete("1.0", tk.END)
        self.tasks_listbox.delete(0, tk.END)
        self.files_listbox.delete(0, tk.END)
        self.progress_bar["value"] = 0
        self.estimated_time_label.config(text="Estimated Time to Completion: 0h 0m")
